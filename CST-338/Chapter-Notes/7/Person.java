...
public class Person
{
    ...
    private Date died;//null indicates still alive.
		...
		// If a method has a parameter of a classType, then null can be used as the corresponding argument when the method is invoked. 
		// null is used as the DOD, if the person is still alive. 
