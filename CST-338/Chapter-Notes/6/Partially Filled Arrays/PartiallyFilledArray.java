...
public class PartiallyFilledArray
{
    ...
    */
    ...
    PartiallyFilledArray(PartiallyFilledArray original)
    {
		...
		/*
			With the use of these accessors, the user of the class would have no need to obtain a list of the entire array, therefore there is not a method (or a way) to access the entire array. These accessors allow the user to get all the data they need. 
		*/
