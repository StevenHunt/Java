...
public class HourlyEmployee extends Employee 
{
    ...
    {
        super( ); // This can be ommited, since the java will still invoke the no-argument constructor for the base class.
        // The inherited instance variables should always be initialized, best place is in the derived constructor by 
        // invoking the base constructor via super( whatever parameters if any ). 
        
        // Initializing instance variables of HourlyEmployee.
        wageRate = 0;
        hours = 0;
        
        /**
        The above is the same as calling another constructor in the same class using the 'this.' keyword 
      	Same As: this("No name", new Date("January", 1, 1000), 0, 0);
      	*/ 
    }
    ...
    */
    public void setRate(double newWageRate)
    {
		...
		// =================== OVERRIDED METHODS (toString and equals are both in the parent class )=========================
